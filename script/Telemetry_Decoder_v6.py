...
class TD_CONFIG(TD_SUPER):
    def read_HK(self, filename):
        ...
        row['Temp_InterfaceMCU'] = (int.from_bytes(chunk[50:52], byteorder='big')-400)/10
...
if __name__ == "__main__":
    ...
    # filename = '20260703_150759.dat'
    filename = '20260703_151000.dat'
    filename = '20260703_150858.dat'
